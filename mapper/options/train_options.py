...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--stylegan_weights', default='./pretrained_models/network-snapshot-final.pkl', type=str, help='Path to StyleGAN model weights')
		self.parser.add_argument('--stylegan_size', default=64, type=int)
